...
This project focuses on predicting customer churn using machine learning models. Churn prediction helps businesses identify customers who are likely to stop using their services. The project leverages various machine learning algorithms, including Random Forest, LightGBM, XGBoost, and CatBoost, to predict churn based on customer attributes.
